# Archive: history, reasoning and deep reference

Nothing here is needed to run the installation. `README.md` in the parent
folder covers that.

This is the record of **why** things are the way they are: every part choice,
every failure and what it turned out to be, every decision that was made and
...
# 1. Setting up an installation host from scratch

The README has the short version. This is every step, for a machine with
nothing on it.
