...
rows = fetch_full_range("11517500", start, end)
...
write_output("shasta", down, norm, scaled, high_var, scale_factor, threshold, "shasta_720.txt")
print(f"downsampled to {len(down)} frames, wrote shasta_720.txt")
